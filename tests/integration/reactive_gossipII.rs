...
#[test]
fn test_basic() {
    let test = get_test_path("rgrII_basic_test.toml");
    let work_dir = create_test_dir("rgrII_basic");
...
fn test_route_discovery_optimization() {
    let test = get_test_path("rgrII_route_discovery_optimization.toml");
    let work_dir = create_test_dir("rgrII_route_discovery_optimization");
