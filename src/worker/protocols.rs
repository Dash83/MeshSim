...
//
//impl<'de> Visitor<'de> for ProtocolsVisitor {
//    type Value = Protocols;
//
//    fn expecting(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
//        formatter.write_str(
//            "A string representing one of the valid Protocols and their respective parameters"
//        )
//    }
//
//    fn visit_str<E>(self, value: &str) -> Result<Protocols, E>
//    where
//        E: de::Error, {
...
//                        match c[0] {
//                            "K" => {
//                                let x: usize = c[1].parse().map_err(
//                                    de::Error::custom
//                                )?;
//                                k = Some(x);
//                            },
//                            "P" => {
//                                let x: f64 = c[1].parse().map_err(
//                                    de::Error::custom
//                                )?;
//                                p = Some(x);
//                            },
...
//            },
//            _ => {
//                Err(de::Error::custom("unsupported protocol"))
//            }
//        }
//    }
//}
